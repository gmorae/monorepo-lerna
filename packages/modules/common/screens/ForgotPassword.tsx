...
import { maskCPF } from '@orbitall-core/utils';
...
const ForgotPassword = () => {
  ...
  const handleSubmit = async () => {
    const { data } = await signin(document, password)
  ...
  return (
    <View style={{
      ...
      <View style={{ marginTop: 16, width: '80%' }}>
        <Text style={{ color: colors.secondary, fontSize: 16, textAlign: 'center' }}>Entre com o documento</Text>
        <TextInput
          placeholder="CPF"
          style={{
            marginTop: 16,
